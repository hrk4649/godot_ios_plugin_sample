...
void PluginClass::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("helloDictionary"), &PluginClass::helloDictionary);
    ClassDB::bind_method(D_METHOD("helloArray"), &PluginClass::helloArray);
    ClassDB::bind_method(D_METHOD("helloFloat"), &PluginClass::helloFloat);
    ClassDB::bind_method(D_METHOD("helloInt"), &PluginClass::helloInt);
    ClassDB::bind_method(D_METHOD("helloSample123"), &PluginClass::helloSample123);
...
String PluginClass::helloSample123(String arg1) {
    NSString *a1 = to_nsstring(arg1);
    return from_nsstring([SwiftClass helloSample123WithA1:a1 ]);

}


int PluginClass::helloInt(int arg1) {

    return [SwiftClass helloIntWithA1:arg1 ];

}


float PluginClass::helloFloat(float arg1) {

    return [SwiftClass helloFloatWithA1:arg1 ];

}


Array PluginClass::helloArray(Array arg1) {
    NSArray *a1 = to_nsarray(arg1);
    return from_nsarray([SwiftClass helloArrayWithA1:a1 ]);

}


Dictionary PluginClass::helloDictionary(Dictionary arg1) {
    NSDictionary *a1 = to_nsdictionary(arg1);
    return from_nsdictionary([SwiftClass helloDictionaryWithA1:a1 ]);
